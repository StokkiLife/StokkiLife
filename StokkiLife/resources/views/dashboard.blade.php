<x-app-layout>
    ...
    <div class="space-y-10">
        <div>
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Visao Geral de hoje</h2>
        ...
        <div>
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Acoes Rapidas</h2>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                <!-- Botão Registar Venda -->
                <a href="{{ route('sales.create') }}" class="bg-green-100 p-6 rounded-lg shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all flex flex-col items-center justify-center text-center">
                    <div class="p-3 bg-white rounded-full mb-3">
                        <i data-lucide="plus-circle" class="w-8 h-8 text-green-800"></i>
                    </div>
                    <span class="text-lg font-semibold text-gray-800">Registar Venda</span>
                </a>

                <!-- Botão Acessos -->
                <a href="{{ route('sales.index') }}" class="bg-green-100 p-6 rounded-lg shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all flex flex-col items-center justify-center text-center">
                    <div class="p-3 bg-white rounded-full mb-3">
                ...
                <!-- Botão Stokki -->
                <a href="{{ route('products.index') }}" class="bg-green-100 p-6 rounded-lg shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all flex flex-col items-center justify-center text-center">
                    <div class="p-3 bg-white rounded-full mb-3">
